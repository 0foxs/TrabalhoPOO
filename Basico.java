...
public class Basico extends Frota{
    
    public Basico(String marca, String modelo, int ano_fabricacao, String cor, String placa, String grupo) {
    ...
    public void mudarValores(){
        ...
        if (ajuste.toLowerCase().contains("diaria")) {
            ...
            Basico.valor_diaria = sc.nextInt();
            sc.nextLine();
        }

        if (ajuste.toLowerCase().contains("tanque")) {
            System.out.print("Digite o modelo do veículo: ");
            Basico.valor_tanque = sc.nextInt();
            sc.nextLine();
        }

        if (ajuste.toLowerCase().contains("interna")) {
            System.out.print("Digite a marca do veículo: ");
            Basico.valor_limpezaExt = sc.nextInt();
            sc.nextLine();
        }

        if (ajuste.toLowerCase().contains("externa")) {
            System.out.print("Digite o modelo do veículo: ");
            Basico.valor_limpezaInt = sc.nextInt();
            sc.nextLine();
        }

        if (ajuste.toLowerCase().contains("seguro")) {
            System.out.print("Digite a marca do veículo: ");
            Basico.valor_seguro = sc.nextInt();
            sc.nextLine();
        }
        sc.close();
    } 
